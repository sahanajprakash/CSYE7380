...
export default function ChatPage() {
  ...
  return (
    <div className='fixed inset-0 flex flex-col bg-slate-50 dark:bg-[#0d1520]'>
      {/* Navbar — matches Navbar.jsx exactly */}
      <nav className='sticky top-0 z-50 shrink-0 border-b border-slate-200 bg-white/80 backdrop-blur-xl dark:border-slate-800/80 dark:bg-[#0d1520]/80'>
